...
void Plotter(){
  ...
  TH1F *hm = (TH1F *)_file0->Get("mupi_mass_minus");
  TH1F *hp = (TH1F *)_file0->Get("mupi_mass_plus");

  //  TString Title("#tau #rightarrow a_{1} #nu   (CLEO Model) " );
  TString Title(" " );
  TString XTitle("M_{#mu#pi}, GeV" );
  ...
  hm->GetXaxis()->SetTitleOffset(0.71);
