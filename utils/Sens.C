...
TFile *SeparatedDecays = TFile::Open("LOCAL_ANALYSIS_templatesmc_defaultSeparatedTauDecays.root");
TFile *InclusiveDecays = TFile::Open("LOCAL_ANALYSIS_templatesmc_defaultInclusiveTaudecays.root");
...
TH1F *template_minus153pi = (TH1F *)SeparatedDecays->Get("templatesmc_default_RecOmegaA1mSignal");
TH1F *template_plus153pi= (TH1F *)SeparatedDecays->Get("templatesmc_default_RecOmegaA1pSignal");

TH1F *template_minus15Incl = (TH1F *)InclusiveDecays->Get("templatesmc_default_RecOmegaA1mSignal");
TH1F *template_plus15Incl= (TH1F *)InclusiveDecays->Get("templatesmc_default_RecOmegaA1pSignal");

TH1F *template_minus154pi = (TH1F *)SeparatedDecays->Get("templatesmc_default_RecOmegaA1mTauBkg");
TH1F *template_plus154pi= (TH1F *)SeparatedDecays->Get("templatesmc_default_RecOmegaA1pTauBkg");


// TH1F *h_data15  = (TH1F *)data->Get("templatesdata_default_RecOmegaA1pData");

TH1F *h3pi = new TH1F("h3pi","h3pi",20,-1.0,1.0);
TH1F *h4pi = new TH1F("h4pi","h4pi",20,-1.0,1.0);
TH1F *hIncl = new TH1F("hIncl","hincl",20,-1.0,1.0);


TH1F *plus3pi  = new TH1F("plus3pi","plus3pi",20,-1.0,1.0);
TH1F *mins3pi  = new TH1F("mins3pi","mins3pi",20,-1.0,1.0);


TH1F *plus4pi  = new TH1F("plus4pi","plus4pi",20,-1.0,1.0);
TH1F *mins4pi  = new TH1F("mins4pi","mins4pi",20,-1.0,1.0);


TH1F *plusIncl = new TH1F("plusIncl","plusIncl",20,-1.0,1.0);
TH1F *minsIncl = new TH1F("minsIncl","minsIncl",20,-1.0,1.0);
...
void Sens(){
  ...
  PerformHisto();
  TH1F *FakeData3pi = new TH1F("FakeData3pi","FakeData3pi",20,-1,1.);
  TH1F *FakeData4pi = new TH1F("FakeData4pi","FakeData4pi",20,-1,1.);
  TH1F *FakeDataIncl = new TH1F("FakeDataIncl","FakeDataIncl",20,-1,1.);
